...
namespace Tanner.OneDrinkAndHome.Core.Migrations
{
    ...
    [Migration("20190429200525_Add-MaxLengthToRut")]
    partial class AddMaxLengthToRut
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tanner.OneDrinkAndHome.Core.Entities.Place", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tanner.OneDrinkAndHome.Core.Entities.Party", b =>
                {
                    ...
                    b.HasOne("Tanner.OneDrinkAndHome.Core.Entities.Place", "Place")
                        .WithMany("Parties")
